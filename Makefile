...
format:
	...
	find . -type f -name '*.go' -not -path './vendor/*' -exec go run -mod=mod github.com/incu6us/goimports-reviser -project-name github.com/bborbe/sample_gmail_oauth -file-path "{}" \;
